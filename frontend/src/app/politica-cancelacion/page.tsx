...
export const metadata = { title: "Política de Cancelación — THE BOSS" };

export default function PoliticaCancelacionPage() {
    const contenido = fs.readFileSync(path.join(process.cwd(), "src/content/politica-cancelacion.md"), "utf-8");
        ...
        <main className="min-h-screen bg-boss-black px-4 py-16">
            <div className="mx-auto max-w-2xl">
                <h1 className="mb-6 font-display text-3xl uppercase tracking-wide text-white">
                    Política de <span className="text-boss-red">Cancelación</span>
                </h1>
